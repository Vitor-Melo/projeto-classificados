...
class Anuncios
{
    ...
    public function getTotalAnuncios($filtros)
    {
        ...
        $sql = $pdo->prepare("SELECT COUNT(*) as quantidade FROM anuncios WHERE ".implode(' AND ', $filtrostring));
    ...
    public function addAnuncio($titulo, $categoria, $valor, $descricao, $estado)
    {
        ...
        titulo = :titulo, id_categoria = :id_categoria, id_usuario = :id_usuario,
        valor = :valor, descricao = :descricao, estado = :estado');
